...
def cal_liquidity(excel_file, company_names, constituents_data,sheet_name):
            ...
            for ticker in company_names:
                try:
                    ...
                    if stock_data is not None:
                        ...
                        total_shares_outstanding = constituents_data.loc[constituents_data["ticker"] == ticker, "Share_outstanding"].values[0]
